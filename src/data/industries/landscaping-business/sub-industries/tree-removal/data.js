...
export const main = {
    heading:
        "Why is Mennr the trusted marketing firm for Tree Removal Businesses in New England?",
    img: "/common/chipy/sub-industries/landscaping-businesses/tree.svg",
    showCertification: true,
};

export const faq = {
    heading: "Marketing FAQ's for Tree Removal companies",
    data: [
        {
...
export const steps = {
    steps: [
        "Seeing how you compare to other Tree Removal businesses in your area is easy",
        "Open a new tab in your browser, and type the following line into your search bar: ‘tree removal near me’",
...
3. Where your website appears on the page (free)`,
    ...
    last: "Talk with one of our Google Certified marketing specialists today, find a marketing strategy that works best for you and your Tree Removal business",
};

export const quote =
    "Apart from experience, our ability to turn struggling businesses into sustaining ones helps Tree Removal companies in New England stay operational for years to come.";
