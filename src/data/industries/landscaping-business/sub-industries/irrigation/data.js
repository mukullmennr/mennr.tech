...
export const main = {
    heading:
        "Why is Mennr the trusted marketing firm for Irrigation Businesses in New England?",
    img: "/common/chipy/sub-industries/landscaping-businesses/irrigation.svg",
    showCertification: true,
};

export const faq = {
    heading: "Marketing FAQ's for Irrigation companies",
    data: [
        {
...
export const steps = {
    steps: [
        "Seeing how you compare to other Irrigation businesses in your area is easy",
        "Open a new tab in your browser, and type the following line into your search bar: ‘irrigation businesses near me’",
...
3. Where your website appears on the page (free)`,
    ...
    last: "Talk with one of our Google Certified marketing specialists today, find a marketing strategy that works best for you and your Irrigation business",
};

export const quote =
    "Apart from experience, our ability to turn struggling businesses into sustaining ones helps Irrigation companies in New England stay operational for years to come.";
