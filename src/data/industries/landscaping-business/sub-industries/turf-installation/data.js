...
export const main = {
    heading:
        "Why is Mennr the trusted marketing firm for Turf Installation Businesses in New England?",
    img: "/common/chipy/sub-industries/landscaping-businesses/turf.svg",
    showCertification: true,
};

export const faq = {
    heading: "Marketing FAQ's for Turf Installation companies ",
    data: [
        {
...
export const steps = {
    steps: [
        "Seeing how you compare to other Turf Installation businesses in your area is easy",
        "Open a new tab in your browser, and type the following line into your search bar: ‘turf installation near me’",
...
export const quote =
    "Apart from experience, our ability to turn struggling businesses into sustaining ones helps Turf Installation companies in New England stay operational for years to come.";
