...
export const main = {
    heading:
        "Why is Mennr the trusted marketing firm for Automotive Tuning Businesses in New England?",
    img: "/common/chipy/sub-industries/automotive-businesses/tuning.svg",
...
export const steps = {
    steps: [
        "Seeing how you compare to other Automotive Tuning businesses in your area is easy",
        "Open a new tab in your browser, and type the following line into your search bar: ‘automotive tuning near me’",
...
3. Where your website appears on the page (free)`,
    ...
    last: "Talk with one of our Google Certified marketing specialists today, find a marketing strategy that works best for you and your Automotive Tuning business",
};

export const quote =
    "Apart from experience, our ability to turn struggling businesses into sustaining ones helps Automotive Tuning companies in New England stay operational for years to come.";
