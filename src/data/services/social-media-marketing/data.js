...
export const main = {
	heading: "Leverage Social Media Reach For Your Local Business",
	text: "Ready to stand out in the crowded digital landscape? Our tailored social media marketing solutions are designed to elevate your brand's online presence, captivate your audience, and convert followers into loyal customers.",
	img: "/services/smm/smm.png",
};
...
export const strategy = {
	...
	content: {
		...
		text: [
			"If done right, Social Media Marketing can become a launch pad for your brand online.         ",
			"Using the right social media strategies combined with compelling content allows your local business to expand your reach, foster meaningful connections, and drive more traffic to your website.             ",
			"Mennr helps you get consistent growth and brand engagement across all your socials, key word being: consistently! ",
		],
	...
	numbers: [
		...
		{ title: "Increase in followers", value: "20%" },
		{ title: "Increase in Engagement        ", value: "40%" },
		{ title: "Increase in CTR", value: "15%" },
		{ title: "Increase in Referral Traffic", value: "50%" },
	],
};

export const content = {
	heading: "Why you can SHOULD focus on Social Media Marketing: ",
	content: [
		{
			heading: "Increase Brand Visibility",
			text: "Social media platforms allow you to showcase your brand to a broader audience. Regularly posting engaging content and interacting with followers can increase brand visibility and make your business more recognizable within your localities. ",
			img: {
				large: "/services/smm/one-768.WebP",
				small: "/services/smm/one-360.WebP",
			},
		},
		{
			heading: "Drive Website Traffic",
			text: "Social media serves as a powerful tool for driving traffic to your website. By sharing links to your website content, promotions, and product pages, you can attract interested visitors and encourage them to explore more about your business.",
			img: {
				large: "/services/smm/two-768.WebP",
				small: "/services/smm/two-360.WebP",
			},
		},
		{
			heading: "Cost-Effective Solution",
			text: "Compared to traditional advertising channels, social media marketing offers a cost-effective way to reach your target audience. With options to set budgets and target specific demographics, you can maximize your marketing dollars and achieve a high return on investment (ROI) for your local business.",
			img: {
				large: "/services/smm/three-768.WebP",
				small: "/services/smm/three-360.WebP",
			},
		},
		{
			heading: "Improve Local SEO",
			text: "Maintaining an active presence on social media can positively impact your local search engine optimization (SEO) efforts. Social signals such as likes, shares, and comments can contribute to your business's online authority and visibility in local search results.",
			img: {
				large: "/services/smm/four-768.WebP",
				small: "/services/smm/four-360.WebP",
			},
		},
		{
			heading: "Stay Ahead of Competitors",
			text: "In today's digital age, having a strong social media presence is essential for staying competitive. By actively maintaining your social media accounts, you can differentiate your business from competitors and gain an edge.",
			img: {
				large: "/services/smm/five-768.WebP",
				small: "/services/smm/five-360.WebP",
			},
		},
	],
};
...
export const faq = {
	...
	data: [
		{
			question:
				"How do you decide which social media platforms should my business be on?            ",
			answer: "Our team carefully examines your business goals, marketing goals, target markets, target audience, and other important factors to determine the most relevant platforms for your business, ensuring maximum reach and engagement.",
		},
		{
			question:
				"How can you help improve my social media presence?            ",
			answer: "Among other things, Mennr will optimize your social media profiles, create engaging content and interact with your audience to enhance your presence and visibility over time.",
		},
		{
			question:
				"Can you help increase my follower count and engagement?            ",
			answer: "Yes, we'll implement strategies tailored to your business and industry to attract new followers, increase engagement rates, and foster meaningful interactions with your audience to grow your social media presence.",
		},
		{
			question:
				"What type of content will you create for my business?            ",
			answer: "We'll develop content tailored to your brand, including a mix of compelling visuals, informative articles, engaging videos, and interactive posts. ",
		},
		{
			question:
				"How will you measure the success of social media marketing campaigns?            ",
			answer: "We'll track key performance metrics such as engagement, reach, clicks, conversions, and ROI to evaluate the effectiveness of any organic or paid campaigns that we run and make data-driven decisions to improve them as we go",
		},
		{
			question:
	...
	card: [
		{
			...
			icon: {
				fill: "/services/smm/one-fill.svg",
				stroke: "/services/smm/one-stroke.svg",
			},
			text: "Understand goals and develop tailored social media strategy.",
		},
		{
			heading: "Platform Selection & Setup",
			icon: {
				fill: "/services/smm/two-fill.svg",
				stroke: "/services/smm/two-stroke.svg",
			},
			text: "Identify, set up, and optimize relevant social media platforms. ",
		},
		{
			heading: "Content Creation & Execution",
			icon: {
				fill: "/services/smm/three-fill.svg",
				stroke: "/services/smm/three-stroke.svg",
			},
		...
		},
		{
			...
			icon: {
				fill: "/services/smm/four-fill.svg",
				stroke: "/services/smm/four-stroke.svg",
			},
		...
		},
		{
			heading: "A/B Testing",
			icon: {
				fill: "/services/smm/five-fill.svg",
				stroke: "/services/smm/five-stroke.svg",
			},
		...
		},
		{
			heading: "Reporting",
			icon: {
				fill: "/services/smm/six-fill.svg",
				stroke: "/services/smm/six-stroke.svg",
			},
...
export const confused = {
	...
	text: [
		"Did you know 180 million+ users use social media on a daily basis in the US alone? Chances are most of your potential customers use it as well.        ",
		"So don't you think it would be wise to be actively building your social media presence if you run a business? We think so too.          ",
		"Through social media marketing, you can connect with your target audience on a deeper level, build brand loyalty, drive meaningful conversations and more. Reach out to us today to get started! ",
	],
	link: getInTouch,
};
