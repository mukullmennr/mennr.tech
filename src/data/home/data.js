...
export const hero = {
    heading: "Online and Offline Solutions For Business Growth",
    text: "We are a family owned business, like yours, established to help other family owned businesses last for generations. Establishing local businesses online and in their communities is what we do best, how can we help?",
    links: [
        {
...
export const road = {
    ...
    text: "Mennr helps local small businesses reach more customers and build longevity through marketing and advertising activities, conducted both online and offline.",
    link: {
...
export const honeyComb = {
    heading: {
        text: "Mennr Services: Cleverly Utilized For ",
...
export const awards = {
    heading: "Awards and certifications held by our team",
    awards: [
        "/awards/google.svg",
        "/awards/amazon.svg",
        "/awards/meta.svg",
        ...
        "/awards/bbb.svg",
        "/awards/consumer-affairs.svg",
        "/awards/localogy-certified.svg",
        "/awards/yext.svg",
        "/awards/sp.svg",
    ],
};
